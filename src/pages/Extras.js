...
export const Extras = () => {
    ...
    const saveItem = (e) => {
        ...
        if (editing){
            axios.put(`${Constants.BASE_URL}/api/extras/${Item.id}`, newItem).then(res => {
            ...
            axios.post(`${Constants.BASE_URL}/api/extras`, newItem).then(res => {
    ...
    const deleteItem = () => {
        axios.delete(`${Constants.BASE_URL}/api/extras/${Item.id}`).then(() => {
