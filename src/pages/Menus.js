...
export const Menus = () => {
    ...
    const saveItem = (e) => {
        ...
        if (editing){
            axios.put(`${Constants.BASE_URL}/api/menus/${Item.id}`, newItem).then(res => {
            ...
            axios.post(`${Constants.BASE_URL}/api/menus`, newItem).then(res => {
    ...
    const deleteItem = () => {
        axios.delete(`${Constants.BASE_URL}/api/menus/${Item.id}`).then(() => {
    ...
    const actionBodyTemplate = (rowData) => {
        return (
            <div className="actions">
                <Button icon="pi pi-eye" className="p-button-rounded p-button-info p-mr-2" onClick={() => {
                    setItem(rowData)
                    setShowItem(true)
                }} />
            ...
            <div className='p-col-12'>
                <div className='card'>
                    ...
                    <DataTable ref={dt} value={Items} selection={selectedItems} onSelectionChange={(e) => setSelectedItems(e.value)}
                        ...
                        <Column field="Title" header="Title" sortable body={(data) => {
                            return bodyTemplate(data.title, 'Title')
                        }}/>
                        <Column field="emp_id" header="Description" sortable body={(data) => {
                            return bodyTemplate(data.description, 'Description')
                        }}/>
                        <Column field="emp_id" header="Image" body={(data) => {
                            return imageBodyTemplate(data.image)
                        }}/>
                        <Column field="emp_id" header="Price" sortable body={(data) => {
                        ...
                        <div className='row'>
                            <div className='col-md-12'>
                                <div className="p-field">
                                    ...
                                    <InputText autoFocus id="first_name" value={Item.title} onChange={(e) => {
                                        const val = e.target.value
                                        let newItem = {...Item, title: val}
                                        setItem(newItem)
                                        console.log(Item)
                                    }} required className={classNames({ 'p-invalid': submitted && !Item.title })} />
                        ...
                        <div className='row'>
                            <div className='col-md-12'>
                                <div className="p-field">
                                    ...
                                    <InputText id="emp_id" value={Item.description} onChange={(e) => {
                                        const val = e.target.value
                                        let newItem = {...Item, description: val}
                                        setItem(newItem)
                                        console.log(Item)
                                    }} required className={classNames({ 'p-invalid': submitted && !Item.description })} />
                        ...
                        <div className='row'>
                            <div className='col-md-12'>
                                <div className="p-field">
                                    ...
                                    <InputText id="street_name" value={Item.image} onChange={(e) => {
                                        const val = e.target.value
                                        let newItem = {...Item, image: val}
                                        setItem(newItem)
                                        console.log(Item)
                                    }} required className={classNames({ 'p-invalid': submitted && !Item.image })} />
                        ...
                        <div className='row'>
                            <div className='col-md-12'>
                                <div className="p-field">
                                    ...
                                    <InputText id="street_name" value={Item.price} onChange={(e) => {
                                        const val = e.target.value
                                        let newItem = {...Item, price: val}
                                        setItem(newItem)
                                        console.log(Item)
                                    }} required className={classNames({ 'p-invalid': submitted && !Item.price })} />
                    ...
                    <Dialog visible={showItem} style={{ width: '450px' }} header="View Menu" modal onHide={hideShowItemDialog}>
                        <div className="p-2">
                            <div className='row'>
                            ...
                            <div className='row pt-0 mt-0'>
                                <h6 className='pt-0 mt-0'><b>Price: {`R${Item.price}`}</b></h6>
                            </div>
                        </div>
                    </Dialog>
                </div>
