            ...
            <div style={{ height: 70, borderBottom: "solid", borderBottomWidth: 0.5, padding: 10, borderBottomColor: "white" }}>
                <div className="row">
                    ...
                    <div className="col-md-10">
                        <h4 style={{ margin: 0, padding: 0, fontWeight: "bold", color: "white" }}>{chat.name}</h4>
                        <p style={{ margin: 0, padding: 0, color: "white" }}>{chat.messages.length > 0 ? chat.messages[chat.messages.length - 1] : "No messages"}</p>
                    </div>
                </div>
            </div>
        );
